const Card1Element = document.querySelector('[data-js="Cards"]');
...
// 
    ...
    Card2Element__text.classList.add("version1");
    Card2Element__text.classList.remove("version4");
    Card2Element__text.classList.remove("version3");
    Card2Element__text.classList.remove("version2");

    Card3Element__text.classList.add("version1");
    Card3Element__text.classList.remove("version4");
    Card3Element__text.classList.remove("version3");
    Card3Element__text.classList.remove("version2");

    Card4Element__text.classList.add("version1");
    Card4Element__text.classList.remove("version4");
...
//
    ...
    Card1Element__text.classList.add("version2");
    Card1Element__text.classList.remove("version4");
    Card1Element__text.classList.remove("version3");
    Card1Element__text.classList.remove("version1");

    Card3Element__text.classList.add("version2");
    Card3Element__text.classList.remove("version4");
    Card3Element__text.classList.remove("version3");
    Card3Element__text.classList.remove("version1");

    Card4Element__text.classList.add("version2");
    Card4Element__text.classList.remove("version4");
    Card4Element__text.classList.remove("version3");
...
version3.addEventListener("click", () => {
    ...
    Card1Element.classList.add("version3");
...
//
    ...
    Card4Element__text.classList.add("version3");
    Card4Element__text.classList.remove("version4");
    Card4Element__text.classList.remove("version2");
    Card4Element__text.classList.remove("version1");

    Card2Element__text.classList.add("version3");
    Card2Element__text.classList.remove("version4");
    Card2Element__text.classList.remove("version2");
    Card2Element__text.classList.remove("version1");

    Card1Element__text.classList.add("version3");
    Card1Element__text.classList.remove("version4");
    Card1Element__text.classList.remove("version2");
    Card1Element__text.classList.remove("version1");
});
...
version4.addEventListener("click", () => {
    ...
    Card1Element.classList.add("version4");
...
// 
    ...
    Card3Element__text.classList.add("version4");
    Card3Element__text.classList.remove("version3");
    Card3Element__text.classList.remove("version2");
   Card3Element__text.classList.remove("version1");

    Card2Element__text.classList.add("version4");
    Card2Element__text.classList.remove("version3");
    Card2Element__text.classList.remove("version2");
    Card2Element__text.classList.remove("version1");

    Card1Element__text.classList.add("version4");
    Card1Element__text.classList.remove("version3");
    Card1Element__text.classList.remove("version2");
    Card1Element__text.classList.remove("version1");
});